...
- [x] Make ships shoot again
- [x] Make ships repel each other when too close
- [ ] Make ships take different orders
...
- [ ] Add ship destruction animations
...
#### P 0.13.6
- Added proper health and damage management
